...
public class EntityBackwardProvGenerator extends EntityGraphGenerator {

    private static final Log l = LogFactory.getLog(EntityBackwardProvGenerator.class);

    public EntityBackwardProvGenerator(EntityEnumType.Enum entityType) {
        super(entityType);
    }
    ...
    protected Document computeProvGraph(Connection connection, String graphURI,
        ...
        while (!unexpandedNodes.empty()) {
            ...
            // we don't need to expand agent nodes for backward provenance
        }
    ...
    protected void addDerivations(Connection connection, int entityID)
        ...
        try {
            // Case 1
            stmt = connection.prepareStatement(PROVSqlQuery.GET_DERIVATIONS_BY_GENERATED_ENTITY_ID);
            ...
            // Case 2
            stmt = connection.prepareStatement(PROVSqlQuery.GET_DERIVATIONS_BY_ACTIVITY_BY_GEN_ENTITY_NO_CONTEXT);
            stmt.setInt(1, entityID);
            resultSet = stmt.executeQuery();
    ...
    protected void addAlternates(Connection connection, int entityID)
        ...
        ResultSet resultSet = null;
        try {
            stmt = connection.prepareStatement(PROVSqlQuery.GET_ALTERNATES_BY_ALT1_ENTITY_ID);
            stmt.setInt(1, entityID);
            resultSet = stmt.executeQuery();
    ...
    protected void addSpecializations(Connection connection, int entityID)
        ...
        ResultSet resultSet = null;
        try {
            stmt = connection.prepareStatement(PROVSqlQuery.GET_SPECIALIZATIONS_BY_SPECIFIC_ENTITY_ID);
            stmt.setInt(1, entityID);
            resultSet = stmt.executeQuery();
    ...
    protected void addMemberships(Connection connection, int entityID)
        ...
        ResultSet resultSet = null;
        try {
            stmt = connection.prepareStatement(PROVSqlQuery.GET_MEMBERSHIPS_BY_MEMBER_ID);
            stmt.setInt(1, entityID);
            resultSet = stmt.executeQuery();
    ...
    protected void addCommunications(Connection connection,
        ...
        try {
            // Case 1
            stmt = connection.prepareStatement(PROVSqlQuery.GET_COMMUNICATIONS_BY_ENTITY_BY_INFORMED_NO_CONTEXT);
            ...
            // Case 2
            stmt = connection.prepareStatement(PROVSqlQuery.GET_COMMUNICATIONS_BY_INFORMED_ACTIVITY_ID);
            stmt.setInt(1, activityID);
